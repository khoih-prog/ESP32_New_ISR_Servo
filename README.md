...
3. Install [**ESP32_New_ISR_Servo** library](https://platformio.org/lib/show/xxxxx/ESP32_New_ISR_Servo) by using [Library Manager](https://platformio.org/lib/show/xxxxx/ESP32_New_ISR_Servo/installation). Search for **ESP32_New_ISR_Servo** in [Platform.io Author's Libraries](https://platformio.org/lib/search?query=author:%22Khoi%20Hoang%22)
